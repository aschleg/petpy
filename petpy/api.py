...
class Petfinder(object):
    ...
    def animals(self, animal_id=None, animal_type=None, breed=None, size=None, gender=None,
        ...
        if before_date is not None:
            ...
            before_date = before_date.replace(tzinfo=datetime.datetime.now().astimezone().tzinfo).astimezone().replace(microsecond=0).isoformat()
        ...
        if after_date is not None:
            ...
            after_date = after_date.replace(tzinfo=datetime.datetime.now().astimezone().tzinfo).astimezone().replace(microsecond=0).isoformat()
