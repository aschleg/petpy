...
.. |offset| replace:: This parameter can be set to the value of :code:`lastOffset` that is returned in a previous call to the method to retrieve the next set of results.
